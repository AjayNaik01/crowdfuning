            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="bg-white rounded-lg shadow-sm">
                    <div className="border-b border-gray-200">
                        <nav className="-mb-px flex space-x-8 px-6">
                            ...
                            <button
                                ...
                                className={`py-4 px-1 border-b-2 font-medium text-sm ${activeTab === 'donations'
                                    ? 'border-indigo-500 text-indigo-600'
                                    : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'
                                    }`}
                            >
                    ...
                    <div className="p-6">
                                ...
                                {campaigns.length === 0 ? (
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                        {campaigns.map((campaign) => (
                                            <div key={campaign._id} className="border border-gray-200 rounded-lg overflow-hidden">
                                                ...
                                                <div className="p-4">
                                                    ...
                                                    <p className="text-sm text-gray-600 mb-3">{campaign.description.substring(0, 100)}...</p>
                                                    <div className="flex items-center justify-between">
                        ...
                        {activeTab === 'donations' && (
                            <div>
                                <h3 className="text-lg font-semibold text-gray-900 mb-4">My Donations</h3>
                                <div className="text-center py-12">
                                    <svg className="mx-auto h-12 w-12 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
